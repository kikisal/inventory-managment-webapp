...
import { PRODUCT_CATEGORIES } from "@shared/globals";
            ...
            <div className="hidden md:block">
              <Card>
                <Table>
                  <TableHeader>
                    <TableRow>
                      <TableHead className="w-[30%]">Nome prodotto</TableHead>
      ...
      <AlertDialog open={!!deletingItemId} onOpenChange={(open) => !open && setDeletingItemId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Questa operazione eliminerà permanentemente questo prodotto.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
